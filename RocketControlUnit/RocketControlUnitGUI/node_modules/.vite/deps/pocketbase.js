...
t = "function" == typeof atob ? atob : (e2) => {
  ...
  for (var s2, i2, n = 0, r = 0, o = ""; i2 = t2.charAt(r++); ~i2 && (s2 = n % 4 ? 64 * s2 + i2 : i2, n++ % 4) ? o += String.fromCharCode(255 & s2 >> (-2 * n & 6)) : 0) i2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(i2);
  return o;
};
var s = "pb_auth";
var BaseAuthStore = class {
  ...
  exportToCookie(e2, t2 = s) {
    ...
    i2.expires = (n == null ? void 0 : n.exp) ? new Date(1e3 * n.exp) : /* @__PURE__ */ new Date("1970-01-01"), e2 = Object.assign({}, i2, e2);
    ...
    if (r.model && a > 4096) {
      ...
      for (const e3 in this.model) s2.includes(e3) && (r.model[e3] = this.model[e3]);
  ...
  async authWithPassword(e2, t2, s2, i2) {
    ...
    return o = this.authResponse(o), r && function registerAutoRefresh(e3, t3, s3, i3) {
      ...
      e3._resetAutoRefresh = function() {
        ...
        if ((_a = o3.query) == null ? void 0 : _a.autoRefresh) return n2 ? n2(r3, o3) : { url: r3, sendOptions: o3 };
...
function normalizeUnknownQueryParams(e2) {
  if (e2) {
    e2.query = e2.query || {};
    for (let t2 in e2) i.includes(t2) || (e2.query[t2] = e2[t2], delete e2[t2]);
  }
}
...
var RecordService = class extends CrudService {
  ...
  async authWithOAuth2(...e2) {
    ...
    if (!s2) throw new ClientResponseError(new Error(`Missing or invalid provider "${t2.provider}".`));
    ...
    return t2.urlCallback || (r = openBrowserPopup(void 0)), new Promise(async (e3, o) => {
      ...
      try {
        await n.subscribe("@oauth2", async (r2) => {
          const a2 = n.clientId;
          try {
            if (!r2.state || a2 !== r2.state) throw new Error("State parameters don't match.");
  ...
  _replaceQueryParams(e2, t2 = {}) {
    ...
    i2 = "";
    for (let e3 in n) n.hasOwnProperty(e3) && ("" != i2 && (i2 += "&"), i2 += encodeURIComponent(e3.replace(/%20/g, "+")) + "=" + encodeURIComponent(n[e3].replace(/%20/g, "+")));
    return "" != i2 ? s2 + "?" + i2 : s2;
  }
};
...
var Client = class {
  ...
  convertToFormDataIfNeeded(e2) {
    ...
    for (let s2 in e2) {
      ...
      if (n.length) for (const e3 of n) t2.append(s2, e3);
      else t2.append(s2, "");
    }
    return t2;
  }
  ...
  hasBlobField(e2) {
    for (let t2 in e2) {
      ...
      for (let e3 of s2) if ("undefined" != typeof Blob && e3 instanceof Blob || "undefined" != typeof File && e3 instanceof File) return true;
    }
    return false;
  }
  getHeader(e2, t2) {
  ...
  serializeQueryParams(e2) {
    ...
    for (const s2 in e2) {
      ...
      if (Array.isArray(i2)) for (const e3 of i2) t2.push(n + "=" + encodeURIComponent(e3));
      else i2 instanceof Date ? t2.push(n + "=" + encodeURIComponent(i2.toISOString())) : null !== typeof i2 && "object" == typeof i2 ? t2.push(n + "=" + encodeURIComponent(JSON.stringify(i2))) : t2.push(n + "=" + encodeURIComponent(i2));
    }
    return t2.join("&");
  }
};
